...
function Anime() {
    ...
    /* Page is dependency here, the function will only run if new page value is different from previous. 
    ...
    */
    ...
    return (
        <div className='w-full bg-gradient-to-b from-[#1e2536] to-[#10141e] md:p-10 mb-20 md:mb-0'>
            ...
            <motion.div
                layout
                className="flex flex-wrap relative justify-evenly md:justify-around gap-5 md:gap-10">
                <AnimatePresence>
                    {
                        loader ? <span className="loader m-10"></span> :
                            <>
                                <InfiniteScroll
                                    className="w-full md:p-2 flex flex-wrap relative justify-evenly md:justify-around gap-5 md:gap-10"
